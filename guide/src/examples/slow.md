...
ในบางกรณีการไบเซกต์แค่ว่าเกิด timeout หรือไม่นั้นไม่พอ อาจมีข้อผิดพลาดการคอมไพล์ด้วย (ดูตัวอย่าง [rustc#139197](https://github.com/rust-lang/rust/issues/139197)) ในกรณีนี้สคริปต์ควรจัดการงานทั้งหมด ต่อไปนี้เป็นตัวอย่าง Bash (สมมติว่า `main.rs` คือโค้ด Rust ที่จำลองการคอมไพล์ที่ค้างได้):
```sh
#!/bin/bash
